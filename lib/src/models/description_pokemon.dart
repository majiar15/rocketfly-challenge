...
//
//     final descriptionPokemon = descriptionPokemonFromJson(jsonString);

import 'dart:convert';

DescriptionPokemon descriptionPokemonFromJson(String str) => DescriptionPokemon.fromJson(json.decode(str));

String descriptionPokemonToJson(DescriptionPokemon data) => json.encode(data.toJson());
...
class DescriptionPokemon {
    ...
    factory DescriptionPokemon.fromJson(Map<String, dynamic> json) => DescriptionPokemon(
